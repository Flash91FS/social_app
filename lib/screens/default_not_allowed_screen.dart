...
const String TAG = "FS - DefaultNotAllowedScreen - ";

class DefaultNotAllowedScreen extends StatefulWidget {
  const DefaultNotAllowedScreen({Key? key}) : super(key: key);

  @override
  _DefaultNotAllowedScreenState createState() => _DefaultNotAllowedScreenState();
}

class _DefaultNotAllowedScreenState extends State<DefaultNotAllowedScreen> with TickerProviderStateMixin {
                                    ...
                                    onTap: () {
                                      ...
                                      if (!error) {
                                        ...
                                        if (emailValid) {
                                          ...
                                          //todo functionality commented for not-allowed-default-screen
