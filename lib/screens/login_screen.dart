              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    mainAxisAlignment:MainAxisAlignment.center,
                    children: [
                    Container(child: const Text("Don't have an account? "), padding: const EdgeInsets.symmetric(vertical: 18),),
                    GestureDetector( onTap: () {
                      _showSnackBar("Sign Up.. Will be implemented soon!");
                    },
                        child: Container(child: const Text("Sign up.", style: TextStyle( color: Colors.deepPurpleAccent, fontWeight: FontWeight.bold),), padding: EdgeInsets.symmetric(vertical: 18),)),
                  ],),
                ],
              ),
            ),
