...
const String TAG = "FS - SignupScreenNew1 - ";

class SignupScreenNew1 extends StatefulWidget {
  const SignupScreenNew1({Key? key}) : super(key: key);

  @override
  _SignupScreenNew1State createState() => _SignupScreenNew1State();
}

class _SignupScreenNew1State extends State<SignupScreenNew1> with TickerProviderStateMixin {
