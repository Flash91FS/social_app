...
const String TAG = "FS - PostCardRect - ";

class PostCardRect extends StatefulWidget {
  final snap;
  final darkMode;
  ...
  @override
  State<PostCardRect> createState() => _PostCardRectState();
}

class _PostCardRectState extends State<PostCardRect> {
  int commentLen = 0;
