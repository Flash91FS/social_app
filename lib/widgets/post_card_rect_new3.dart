...
const String TAG = "FS - PostCardRectNew3 - ";

class PostCardRectNew3 extends StatefulWidget {
  final snap;
  final darkMode;

  const PostCardRectNew3({
    Key? key,
    required this.snap,
  ...
  @override
  State<PostCardRectNew3> createState() => _PostCardRectNew3State();
}

class _PostCardRectNew3State extends State<PostCardRectNew3> {
  int commentLen = 0;
  ...
  void openSpotDetailsScreen(snap, String multiImages) {
  ...
  LinearGradient storyGradient = const LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Colors.transparent, Colors.black45]);
  ...
  Widget getCarouselSliderOld(){
    ...
    try {
      multiImages = widget.snap.containsKey("multiImages") ? widget.snap["multiImages"] : "0";
      if(multiImages == "1" && widget.snap.containsKey("imagesList")){
              ...
              children: [
                Container(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: multiImages == "1" ? "${mapEntry.value}" : "https://images.unsplash.com/photo-1532264523420-881a47db012d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9%27",
  ...
  Widget getCarouselSlider(){
    log("getCarouselSlider(): _current = $_current");
    ...
    return Stack(
      children: [
            ...
            return Builder(
              builder: (BuildContext context) {
                return Container(
                  ...
                  // ),
                  child: CachedNetworkImage(
                    imageUrl: "https://images.unsplash.com/photo-1532264523420-881a47db012d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9%27",
                    // imageUrl: "http://via.placeholder.com/350x150",
                    imageBuilder: (context, imageProvider) => Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
        ...
        Positioned(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: ["a1","a2","a3","a4","a5"].asMap().entries.map((entry) {
              log("entry = $entry");
              return Container(
                width: 12.0,
                height: 12.0,
  ...
  Widget build(BuildContext context) {
    ...
    try {
      ...
      log("$TAG build() : Error == ${err.toString()}");
    }
    ...
    if (user == null) {
      ...
      return GestureDetector(
        onTap: () {
          ...
          openSpotDetailsScreen(widget.snap, multiImages);
        },
        onDoubleTap: () {
                        ...
                        child: GestureDetector(
                          ...
                          child: Stack(
                            ...
                            children: [
                              Container(
                                // color: Colors.grey[900],
                                height: postHeight, // MediaQuery.of(context).size.width*0.77,// 300, //MediaQuery.of(context).size.height * 0.36,
                                width: double.infinity,
                                // child: Image.network(
