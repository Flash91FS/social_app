...
const String TAG = "FS - VideoPostCard2 - ";

class VideoPostCard2 extends StatefulWidget {

  final snap;

  const VideoPostCard2({
    Key? key,
    required this.snap,
  }) : super(key: key);

  @override
  State<VideoPostCard2> createState() => _VideoPostCard2State();
}

class _VideoPostCard2State extends State<VideoPostCard2> {
